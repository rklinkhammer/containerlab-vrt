...
OUT=ROOT/'artifacts/processor-recovery-qualification/trial';OUT.mkdir(parents=True,exist_ok=True)
...
try:
 ...
 except Exception as e:case.update(outcome='FAIL',reason=str(e));records('processor','failure')
