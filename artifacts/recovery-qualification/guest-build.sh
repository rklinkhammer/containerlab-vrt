...
mkdir -p artifacts/recovery-qualification
...
sudo docker image inspect containerlab-vrt-app:local > artifacts/recovery-qualification/image.json

containerlab deploy --help > artifacts/recovery-qualification/deploy-help.txt
containerlab destroy --help > artifacts/recovery-qualification/destroy-help.txt
containerlab redeploy --help > artifacts/recovery-qualification/redeploy-help.txt
containerlab version > artifacts/recovery-qualification/native-version.txt
