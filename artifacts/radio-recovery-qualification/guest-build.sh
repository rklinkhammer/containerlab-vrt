...
mkdir -p artifacts/radio-recovery-qualification
...
sudo docker image inspect containerlab-vrt-app:local > artifacts/radio-recovery-qualification/image.json

containerlab deploy --help > artifacts/radio-recovery-qualification/deploy-help.txt
containerlab destroy --help > artifacts/radio-recovery-qualification/destroy-help.txt
containerlab redeploy --help > artifacts/radio-recovery-qualification/redeploy-help.txt
containerlab version > artifacts/radio-recovery-qualification/native-version.txt
